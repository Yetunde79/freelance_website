        ...
        <div className="faq-items">
          <Accordion>
            <AccordionItem>
              ...
              <AccordionItemPanel>
                <p>
                  I’m a developer that not only works on the technical aspect of
                  your website but consults with you so the business strategy is
                  reflected on your site. Also, I guarantee clear communication
            ...
            <AccordionItem>
              ...
              <AccordionItemPanel>
                <p>
                  ...
                  possible, we'll make the perfect site for you. How quickly we
                  create your website depends on you: The faster we get all your
                  information (e.g. for the contact page), your own text and
                  pictures, the faster I can get started.
                </p>
              </AccordionItemPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionItemPanel>
                <p>
                  The contract lasts till the project has been delivered to you
                  or either party wants to end the contract.{" "}
                </p>
              </AccordionItemPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionItemPanel>
                <p>
                  Once a week, we will have a phone call discussing my progress
                  and expected progress on your website for next week.
                </p>
              </AccordionItemPanel>
            </AccordionItem>
